    ...
    <section className="section-padding">
      <div className="container-narrow max-w-3xl">
        ...
        <div className="mt-8 space-y-4 text-muted-foreground leading-relaxed">
          ...
          <p>Home Nexio ("we", "us", or "our") operates the website. This page informs you of our policies regarding the collection, use, and disclosure of personal information when you use our site.</p>
          ...
          <p>If you have questions about this policy, please contact us at <a href="mailto:contact@homenexio.com" className="text-accent underline hover:text-accent/80">contact@homenexio.com</a>.</p>
        </div>
      </div>
    </section>
  </Layout>
