    ...
    <section className="section-padding">
      <div className="container-narrow max-w-3xl">
        ...
        <div className="mt-8 space-y-4 text-muted-foreground leading-relaxed">
          ...
          <p>By accessing and using Home Nexio, you agree to be bound by these Terms of Service. If you do not agree, please do not use this website.</p>

          <h2 className="font-heading text-xl font-bold text-foreground">Use of Content</h2>
          <p>All content on this website — including text, images, graphics, and other materials — is the property of Home Nexio and is protected by copyright law. You may not reproduce, distribute, modify, or create derivative works from any content without prior written permission.</p>
          ...
          <p>Home Nexio shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use of this website or reliance on any information provided herein.</p>
          ...
          <p>For questions regarding these terms, contact us at <a href="mailto:contact@homenexio.com" className="text-accent underline hover:text-accent/80">contact@homenexio.com</a>.</p>
        </div>
      </div>
    </section>
  </Layout>
