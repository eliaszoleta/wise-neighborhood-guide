...
const About = () => {
  return (
    <Layout>
      <Helmet>
        <title>About Neighborhood Guidelines | Real Estate Education by Elias Zoleta</title>
        <meta name="description" content="Learn about Elias Zoleta, the founder of Neighborhood Guidelines — a real estate educator with years of experience in content creation, CRM automation, and property investing strategies." />
        <link rel="canonical" href="https://neighborhoodguidelines.com/about" />
      </Helmet>
      ...
      <section className="section-padding">
        <div className="container-narrow max-w-3xl">
          ...
          <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed">
            <p>
              Neighborhood Guidelines was founded by <strong className="text-foreground">Elias Zoleta</strong> — a real estate content specialist and automation expert with over 4 years of experience helping real estate professionals, investors, and agencies scale their businesses through strategic content, CRM systems, and digital marketing.
            </p>
            ...
            <p>
              We believe that real estate is one of the most powerful wealth-building tools available. But the industry can be overwhelming — filled with jargon, gatekeeping, and outdated advice. Neighborhood Guidelines exists to make real estate education <strong className="text-foreground">accessible, practical, and actionable</strong> for everyone, regardless of experience level or financial background.
            </p>
