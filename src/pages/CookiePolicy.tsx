...
const CookiePolicy = () => (
  <Layout>
    <Helmet>
      <title>Cookie Policy | Peasant House</title>
      <meta name="description" content="Learn how Peasant House uses cookies and similar technologies to improve your browsing experience." />
    </Helmet>
    ...
    <section className="section-padding">
      <div className="container-narrow max-w-3xl">
        ...
        <div className="mt-8 space-y-4 text-muted-foreground leading-relaxed">
          ...
          <p>Peasant House uses cookies for the following purposes:</p>
          ...
          <p>If you have questions about our use of cookies, contact us at <a href="mailto:contact@peasanthouse.com" className="text-accent underline hover:text-accent/80">contact@peasanthouse.com</a>.</p>
        </div>
      </div>
    </section>
  </Layout>
