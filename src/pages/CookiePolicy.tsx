...
const CookiePolicy = () => (
  <Layout>
    <Helmet>
      <title>Cookie Policy | Neighborhood Guidelines</title>
      <meta name="description" content="Learn how Neighborhood Guidelines uses cookies and similar technologies to improve your browsing experience." />
    </Helmet>
    ...
    <section className="section-padding">
      <div className="container-narrow max-w-3xl">
        ...
        <div className="mt-8 space-y-4 text-muted-foreground leading-relaxed">
          ...
          <p>Neighborhood Guidelines uses cookies for the following purposes:</p>
          ...
          <p>If you have questions about our use of cookies, contact us at <a href="mailto:contact@neighborhoodguidelines.com" className="text-accent underline hover:text-accent/80">contact@neighborhoodguidelines.com</a>.</p>
        </div>
      </div>
    </section>
  </Layout>
