...
const RentalPropertyExpenses = () => (
  <BlogPost
    ...
    slug="property-management/rental-property-expenses"
  ...
  >
    ...
    <p>A property renting for $1,500/month with an $1,100 mortgage payment is not generating $400/month in profit. Our <Link to="/blog/investing/first-rental-property">first rental property guide</Link> covers how to build an accurate expense model before you make an offer. It might be generating $0. It might be negative. Here's the actual math.</p>
