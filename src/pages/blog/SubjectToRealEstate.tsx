...
const SubjectToRealEstate = () => (
  <BlogPost
    ...
    category="Financing"
    faqs={[
      { q: "What does 'subject to' mean in real estate?", a: "Buying a property 'subject to' means you take title to the property while the seller's existing mortgage remains in place — you make payments on a loan you never signed for, at the rate and terms the seller originally negotiated. You own the property; the loan stays in the seller's name. The appeal is acquiring a property with an existing below-market interest rate without qualifying for new financing." },
      { q: "Is buying subject to real estate legal?", a: "Subject-to transactions are legal. You are purchasing the property through a deed transfer, which is a standard legal act. The risk is not legality — it's the due-on-sale clause in most conventional mortgages, which gives the lender the right to call the full loan balance due if ownership transfers. Lenders often don't enforce this clause as long as payments continue, but the risk is real and non-zero." },
      { q: "What is the due-on-sale clause and how does it affect subject-to deals?", a: "The due-on-sale clause is a provision in most conventional mortgages that allows the lender to demand full repayment of the loan balance if the property is sold or transferred without their approval. In a subject-to deal, ownership transfers to you but the lender is never notified. If the lender discovers the transfer and invokes the clause, the full balance is immediately due — and if you can't refinance or pay it off, foreclosure follows." },
