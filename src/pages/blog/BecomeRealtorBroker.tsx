...
const BecomeRealtorBroker = () => (
  ...
  >
    ...
    <h2>Agent vs. Realtor vs. Broker — The Actual Differences</h2>
    <p>
    ...
    <h2>What Agents Actually Do Day to Day</h2>
    <p>
    ...
    <h2>Choosing Your First Brokerage</h2>
    <p>
